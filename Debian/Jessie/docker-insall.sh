...
apt-key adv --keyserver hkpp80.pool.sks-keyservers.net80 --recv-keys 58118E89F3A912897C070ADBF76221572C52609D && 
echo deb httpsapt.dockerproject.orgrepo debian-jessie main  etcaptsources.list.ddocker.list && 
apt-get --yes update  && 
